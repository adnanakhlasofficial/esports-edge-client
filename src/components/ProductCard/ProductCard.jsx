...
const ProductCard = ({ equipment, handleRemoveEquipment }) => {
  return (
    <div className="p-4 bg-slate-200 dark:bg-[#161838] rounded-lg hover:shadow-lg transition duration-300 flex flex-col lg:hover:-translate-x-1 lg:hover:-translate-y-1 ">
      ...
      <div className="p-4 grow">
        ...
        <p className="text-gray-600 dark:text-gray-400">{equipment.category}</p>
        ...
        <p
          className={`mt-2 ${
            equipment.stockAvailability ? "text-green-500" : "text-red-500"
          }`}
        >
      ...
      <div className="flex flex-col gap-2">
        <Link className="w-full" to={`/updateEquipment/${equipment._id}`}>
