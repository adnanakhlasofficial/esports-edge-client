  ...
  return (
    <HelmetProvider>
      ...
      <section className="wrapper flex items-center flex-col lg:flex-row gap-4">
        <div>
          <img src={loginSvg} alt="Account Access Vector Image" />
        </div>
        <div className="w-full min-h-screen grid place-items-center">
          <div className="bg-slate-200 dark:bg-darkPurple !p-8 my-12 rounded-xl !max-w-xl w-full dark:*:text-slate-200">
